...
filename = '/Users/jocekav/Documents/GitHub/2022-MUSI6106/acomic.wav';
...
compFile = '/Users/jocekav/Documents/GitHub/2022-MUSI6106/acomic_IIR.wav';
[compX,Fs] = audioread(compFile);

diff = transpose(compX(1:22000)) - y(1:22000);
xAxis = 1:22000;
% plot(xAxis, transpose(compX(1:22000)), xAxis, y(1:22000), xAxis, diff, 'LineWidth', 1);
% legend({'Matlab function','C++ Implementation', 'Difference'})
% title('IIR comparison')
